<?php
    ...
    foreach($lineas as $cord => $val)
    {
        ...
        {
           $lineas[$cadena] = "<img src= 'extraterrestre.jpg' width= 30 height= 30> ";
           echo "<h2>¡Has derribado a un ovni!</h2>";
        }
        elseif($cadena == $cord && (($cadena != $n1) || ($cadena!=$n2)||($cadena!=$n3)))
        {
            $lineas[$cadena] = "<img src= 'hoyito.jpg' width= 30 height= 30> ";
            $vidas-= 1;
        }
    }
        //imprime la tabla
